...
public class SentBoxTabbed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sent_box_tabbed);
        ...
        navigationView=(NavigationView)findViewById(R.id.navigationViewSentBoxTabbed);
