...
public class DoctorSentboxTabbed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_sentbox_tabbed);

        mAuth=FirebaseAuth.getInstance();
        FirebaseUser user=mAuth.getCurrentUser();

        drawerLayout=(DrawerLayout)findViewById(R.id.DrawerLayoutDoctorSentBoxTabbed);
        Toggle=new ActionBarDrawerToggle(this,drawerLayout,R.string.open,R.string.close);

        drawerLayout.addDrawerListener(Toggle);
        Toggle.syncState();

        navigationView=(NavigationView)findViewById(R.id.navigationViewDoctorSentBoxTabbed);
...
//        setSupportActionBar(toolbar);
    ...
    private void LogOutAsDoctor() {
        ...
        finish();
        Intent intent= new Intent(DoctorSentboxTabbed.this, Home.class);
